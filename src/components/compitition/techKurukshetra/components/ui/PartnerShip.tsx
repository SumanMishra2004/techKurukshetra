      ...
      <div className="flex h-fit w-[90vw] flex-col justify-between items-start">
        ...
        <div className="md:h-fit h-fit w-full flex flex-wrap justify-start gap-7 items-center ">
          <Fade direction="right" triggerOnce>
            <div className="elements1 justify-center h-[10rem] w-[18rem] rounded-tl-xl rounded-br-xl border-2 flex flex-col items-center overflow-hidden">
          ...
          </Fade> <Fade direction="right" triggerOnce>
            <div className="elements1 justify-center h-[10rem] w-[18rem] rounded-tl-xl rounded-br-xl border-2 flex flex-col items-center">
