  ...
  return (
    ...
    <a href={link} target="_blank" rel="noopener noreferrer">
      ...
      <button className="relative inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-lg p-[1px] focus:outline-none z-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7  font-medium text-white backdrop-blur-3xl gap-2 undefined text-xl">
          Join Whatsapp
          <FaWhatsapp />
        </span>
      </button>
